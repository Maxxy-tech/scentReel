...
const Otp = () => {
  ...
  return (
    <div className="mt-[4px] w-full bg-[#f1f1]">
      <h4 className="text1">Enter Otp sent to your email here</h4>
        ...
        <h5 className="text-red-600 mt-10 text-center capitalize font-thin tracking-wide w-full">
          {isExpired ? (
            <p>
              Token has expired
              <button
                className="border-[1px] w-[100px] cursor-pointer uppercase m-2 bg-blue-900 mt-[20px] text-white"
                onClick={ResendOtp}
              >
                {isLoading ? (
                  <Spinner
            ...
            <p>
              <span className="text-[22px] mr-2 small">OTP expires in</span>
              <span className="text-[25px] font-extrabold small">
                {minutes}
              </span>{" "}
              <span className="font-bold text-[20px] m-0">:</span>{" "}
